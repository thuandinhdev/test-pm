...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"modal-header\">\n\t<h2 class=\"modal-title font-weight-normal\"><i class=\"fa fa-newspaper-o  modal-icon\" aria-hidden=\"true\"></i>&nbsp;{{'knowledge_base.article.title' | translate}}</h2>\n\t<button type=\"button\" class=\"close\" (click)=\"onCancel()\"><span aria-hidden=\"true\">&times;</span></button>\n</div>\n<form class=\"form\" [formGroup]=\"articleCreateForm\" (ngSubmit)=\"onSubmit()\">\n\t<div class=\"modal-body\">\n\t\t<div class=\"form-body\">\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"article_title\">{{'knowledge_base.article.create.fields.article_title' | translate}}<span class=\"text-danger\">&nbsp;*</span></label>\n\t\t\t\t\t\t<input type=\"text\" formControlName=\"article_title\" placeholder=\"{{'knowledge_base.article.create.placeholders.placeholder1' | translate}}\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && articleControl.article_title.errors }\" />\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && articleControl.article_title.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"articleControl.article_title.errors.required\">{{'knowledge_base.article.create.error_messages.message1' | translate}}</div>\n\t\t\t\t\t\t\t<div *ngIf=\"articleControl.article_title.errors.maxlength\">{{'knowledge_base.article.create.error_messages.message2' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-md-12\" *ngIf=\"isPageLoaded\">\n\t\t\t\t\t<div class=\"form-group\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && articleControl.category_id.errors }\">\n\t\t\t\t\t\t<label for=\"category_name\">{{'knowledge_base.article.create.fields.category' | translate}}<span class=\"text-danger\">&nbsp;*</span></label>\n\t\t\t\t\t\t<ng-select [searchable]=\"true\"\n\t\t\t\t\t\t\t[items]=\"categories\"\n\t\t\t\t\t\t\t[selectOnTab]=\"true\"\n\t\t\t\t\t\t\tbindLabel=\"category_name\"\n\t\t\t\t\t\t\tbindValue=\"id\"\n\t\t\t\t\t\t\tlabelForId=\"category_id\"\n\t\t\t\t\t\t\tformControlName=\"category_id\"\n\t\t\t\t\t\t\tplaceholder=\"{{'knowledge_base.article.create.placeholders.placeholder2' | translate}}\">\n\t\t\t\t\t\t</ng-select>\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && articleControl.category_id.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"articleControl.category_id.errors.required\">{{'knowledge_base.article.create.error_messages.message3' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label>{{'knowledge_base.article.create.fields.file' | translate}}</label>\n\t\t\t\t\t\t<input type=\"hidden\" formControlName=\"file\">\n\t\t\t\t\t\t<div class=\"dropzone dz-clickable\" #logodropzone>\n\t\t\t\t\t\t\t<div class=\"dz-default dz-message\"><span><strong>{{'knowledge_base.article.create.error_messages.message4' | translate}}</strong></span></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<input type=\"hidden\" formControlName=\"file_extension\">\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && articleControl.description.errors }\">\n\t\t\t\t\t\t<label for=\"description\">{{'knowledge_base.article.create.fields.description' | translate}}<span class=\"text-danger\">&nbsp;*</span></label>\n\t\t\t\t\t\t<app-ngx-editor height=\"100px\" minHeight=\"50px\" [placeholder]=\"'knowledge_base.article.create.placeholders.placeholder3' | translate\" [spellcheck]=\"true\" formControlName=\"description\" id=\"description\"></app-ngx-editor>\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && articleControl.description.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"articleControl.description.errors.required\">{{'knowledge_base.article.create.error_messages.message5' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<div class=\"modal-footer\">\n\t\t<button type=\"button\" class=\"btn btn-cancel mb-0\" (click)=\"onCancel()\">{{'common.close' | translate}}</button>\n\t\t<button class=\"btn btn-submit mb-0\">{{'common.create' | translate}}</button>\n\t</div>\n</form>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"modal-header\">\n\t<h2 class=\"modal-title font-weight-normal\"><i class=\"fa fa-newspaper-o modal-icon\" aria-hidden=\"true\"></i>&nbsp;{{'knowledge_base.article.title' | translate}}</h2>\n\t<button type=\"button\" class=\"close\" (click)=\"onCancel()\"><span aria-hidden=\"true\">&times;</span></button>\n</div>\n<form class=\"form\" [formGroup]=\"articleEditForm\" (ngSubmit)=\"onSubmit()\">\n\t<div class=\"modal-body\">\n\t\t<div class=\"form-body\">\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"article_title\">{{'knowledge_base.article.create.fields.article_title' | translate}}<span class=\"text-danger\">&nbsp;*</span></label>\n\t\t\t\t\t\t<input type=\"text\" formControlName=\"article_title\" placeholder=\"{{'knowledge_base.article.create.placeholders.placeholder1' | translate}}\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && articleControl.article_title.errors }\" />\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && articleControl.article_title.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"articleControl.article_title.errors.required\">{{'knowledge_base.article.create.error_messages.message1' | translate}}</div>\n\t\t\t\t\t\t\t<div *ngIf=\"articleControl.article_title.errors.maxlength\">{{'knowledge_base.article.create.error_messages.message2' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\"\n\t\t\t\t\t\t[ngClass]=\"{ 'is-invalid': isFormSubmitted && articleControl.category_id.errors }\">\n\t\t\t\t\t\t<label for=\"category_name\">{{'knowledge_base.article.create.fields.category' | translate}}<span class=\"text-danger\">&nbsp;*</span></label>\n\t\t\t\t\t\t<ng-select [searchable]=\"true\"\n\t\t\t\t\t\t\t[items]=\"categories\"\n\t\t\t\t\t\t\t[selectOnTab]=\"true\"\n\t\t\t\t\t\t\tbindLabel=\"category_name\"\n\t\t\t\t\t\t\tbindValue=\"id\"\n\t\t\t\t\t\t\tlabelForId=\"category_id\"\n\t\t\t\t\t\t\tformControlName=\"category_id\"\n\t\t\t\t\t\t\tplaceholder=\"{{'knowledge_base.article.create.placeholders.placeholder2' | translate}}\"\n\t\t\t\t\t\t\t[ngClass]=\"{ 'is-invalid': isFormSubmitted && articleControl.category_id.errors }\">\n\t\t\t\t\t\t</ng-select>\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && articleControl.category_id.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"articleControl.category_id.errors.required\">{{'knowledge_base.article.create.error_messages.message3' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label>{{'knowledge_base.article.create.fields.file' | translate}}</label>\n\t\t\t\t\t\t<input type=\"hidden\" formControlName=\"file\">\n\t\t\t\t\t\t<div class=\"dropzone dz-clickable\" #logodropzone>\n\t\t\t\t\t\t\t<div class=\"dz-default dz-message\"><span><strong>{{'knowledge_base.article.create.error_messages.message4' | translate}}</strong></span></div>\n\t\t\t\t\t\t\t<div class=\"dz-preview dz-image-preview\" *ngIf=\"article.file_name\" id=\"dropZoneFile\">\n\t\t\t\t\t\t\t\t<div class=\"dz-image\">\n\t\t\t\t\t\t\t\t\t<img src=\"{{apiUrl}}/uploads/article_attachment/{{article.file_name}}\" />\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<a class=\"btn btn-default btn-sm btn-block\" (click)=\"removeDropzoneFiles()\">{{'common.remove_file' | translate}}</a>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<input type=\"hidden\" formControlName=\"file_extension\">\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\"\n\t\t\t\t\t\t[ngClass]=\"{ 'is-invalid': isFormSubmitted && articleControl.description.errors }\">\n\t\t\t\t\t\t<label for=\"description\">{{'knowledge_base.article.create.fields.description' | translate}}<span class=\"text-danger\">&nbsp;*</span></label>\n\t\t\t\t\t\t<app-ngx-editor height=\"100px\" minHeight=\"50px\" [placeholder]=\"'knowledge_base.article.create.placeholders.placeholder3' | translate\" [spellcheck]=\"true\" formControlName=\"description\" id=\"description\"></app-ngx-editor>\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && articleControl.description.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"articleControl.description.errors.required\">{{'knowledge_base.article.create.error_messages.message5' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<div class=\"modal-footer\">\n\t\t<button type=\"button\" class=\"btn btn-cancel mb-0\" (click)=\"onCancel()\">{{'common.close' | translate}}</button>\n\t\t<button class=\"btn btn-submit mb-0\">{{'common.update' | translate}}</button>\n\t</div>\n</form>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"modal-header\">\n\t<h2 class=\"modal-title font-weight-normal\"><i class=\"fa fa-list modal-icon\" aria-hidden=\"true\"></i>&nbsp;{{'knowledge_base.category.title' | translate}}</h2>\n\t<button type=\"button\" class=\"close\" (click)=\"onCancel()\"><span aria-hidden=\"true\">&times;</span></button>\n</div>\n<form class=\"form\" [formGroup]=\"categoryEditForm\" (ngSubmit)=\"onSubmit()\">\n\t<div class=\"modal-body\">\n\t\t<div class=\"form-body\">\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"category_name\">{{'knowledge_base.category.create.fields.category_name' | translate}}<span class=\"text-danger\">&nbsp;*</span></label>\n\t\t\t\t\t\t<input type=\"text\" formControlName=\"category_name\" placeholder=\"{{'knowledge_base.category.create.placeholders.placeholder1' | translate}}\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && categoryControl.category_name.errors }\" />\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && categoryControl.category_name.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"categoryControl.category_name.errors.required\">{{'knowledge_base.category.create.error_messages.message1' | translate}}</div>\n\t\t\t\t\t\t\t<div *ngIf=\"categoryControl.category_name.errors.maxlength\">{{'knowledge_base.category.create.error_messages.message2' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && categoryControl.file.errors }\">\n\t\t\t\t\t\t<label>{{'knowledge_base.category.create.fields.category_logo' | translate}}</label>\n\t\t\t\t\t\t<input type=\"hidden\" formControlName=\"file\">\n\t\t\t\t\t\t<div class=\"dropzone dz-clickable\" #logodropzone>\n\t\t\t\t\t\t\t<div class=\"dz-default dz-message\"><span><strong>{{'knowledge_base.category.create.error_messages.message3' | translate}}</strong></span></div>\n\t\t\t\t\t\t\t<div class=\"dz-preview dz-image-preview\" *ngIf=\"category.category_logo && isCompanyLogoUploaded\" id=\"dropZoneFile\">\n\t\t\t\t\t\t\t\t<div class=\"dz-image\">\n\t\t\t\t\t\t\t\t\t<img src=\"{{apiUrl}}/uploads/category_attachment/{{category.category_logo}}\" />\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<a class=\"btn btn-default btn-sm btn-block\" (click)=\"removeDropzoneFiles()\">{{'common.remove_file' | translate}}</a>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && categoryControl.file.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"categoryControl.file.errors.required\">{{'knowledge_base.category.create.error_messages.message4' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<input type=\"hidden\" formControlName=\"file_extension\">\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<div class=\"modal-footer\">\n\t\t<button type=\"button\" class=\"btn btn-cancel mb-0\" (click)=\"onCancel()\">{{'common.close' | translate}}</button>\n\t\t<button type=\"submit\" class=\"btn btn-submit mb-0\">{{'common.update' | translate}}</button>\n\t</div>\n</form>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<section>\n\t<div class=\"row\">\n\t\t<!-- Tree view -->\n\t\t<div class=\"col-md-4\">\n\t\t\t<category-articles-tree></category-articles-tree>\n\t\t</div>\n\t\t<div class=\"col-md-8\" *ngIf=\"isPageLoaded\">\n\t\t\t<div class=\"card\">\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<!-- Card header -->\n\t\t\t\t\t<div class=\"card-header pl-0 pr-0\">\n\t\t\t\t\t\t<h4 class=\"sub-title mt-2\"><span>{{article.article_title}}</span></h4>\n\t\t\t\t\t\t<div class=\"card-buttons\">\n\t\t\t\t\t\t\t<button (click)=\"openEditArticleModal(article)\" class=\"btn btn-create mb-2 mb-lg-0\" tooltip=\"{{'common.edit' | translate}}\"><i class=\"fa fa-pencil-square-o\"></i></button>\n\t\t\t\t\t\t\t<button [routerLink]=\"['/knowledgebase/category/',article.category_id]\" class=\"btn btn-create mb-2 mb-lg-0\" tooltip=\"{{'common.back' | translate}}\"><i class=\"fa fa-angle-double-left\"></i></button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"card-content pb-2\">\n\t\t\t\t\t\t<div class=\"card-body\">\n\t\t\t\t\t\t\t<div class=\"row\" class=\"knowledgebase-meta\">\n\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t\t\t<li><strong>{{'common.created' | translate}} :</strong> {{article.created_at | dateTimeFormatFilter: loginUser.settings.date_time_format}}</li>\n\t\t\t\t\t\t\t\t\t\t<li><strong>{{'common.last_updated' | translate}} :</strong> {{article.updated_at | dateTimeFormatFilter: loginUser.settings.date_time_format}}</li>\n\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t\t<div [innerHTML]=\"article.description\"></div>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</section>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"card\">\n\t<div class=\"col-md-12\">\n\t\t<!-- Card header -->\n\t\t<div class=\"card-header pl-0 pr-0\">\n\t\t\t<h4 class=\"main-title mt-2\"><span>{{'knowledge_base.title' | translate}}</span></h4>\n\t\t</div>\n\t\t<div class=\"card-content pb-2\">\n\t\t\t<div class=\"card-body overflow-x-auto overflow-y-hidden height-600\">\n\t\t\t\t<div id=\"jstree1\" class=\"jstree_size\">\n\t\t\t\t\t<ul>\n\t\t\t\t\t\t<li data-jstree='{ \"opened\" : true, \"disabled\" : true }' *ngFor=\"let category of categoryLists\">{{category.category_name}}\n\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t<li data-jstree='{\"type\":\"html\"}' *ngFor=\"let article of category.articles\"><a href=\"{{basURL}}/#/knowledgebase/category/{{category.id}}/article/{{article.id}}\">{{article.article_title}}</a></li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"modal-header\">\n\t<h2 class=\"modal-title font-weight-normal\"><i class=\"fa fa-list modal-icon\" aria-hidden=\"true\"></i>&nbsp;{{'knowledge_base.category.title' | translate}}</h2>\n\t<button type=\"button\" class=\"close\" (click)=\"onCancel()\"><span aria-hidden=\"true\">&times;</span></button>\n</div>\n<form class=\"form\" [formGroup]=\"categoryCreateForm\" (ngSubmit)=\"onSubmit()\">\n\t<div class=\"modal-body\">\n\t\t<div class=\"form-body\">\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<label for=\"category_name\">{{'knowledge_base.category.create.fields.category_name' | translate}}<span class=\"text-danger\">&nbsp;*</span></label>\n\t\t\t\t\t\t<input type=\"text\" formControlName=\"category_name\" placeholder=\"{{'knowledge_base.category.create.placeholders.placeholder1' | translate}}\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && categoryControl.category_name.errors }\" />\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && categoryControl.category_name.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"categoryControl.category_name.errors.required\">{{'knowledge_base.category.create.error_messages.message1' | translate}}</div>\n\t\t\t\t\t\t\t<div *ngIf=\"categoryControl.category_name.errors.maxlength\">{{'knowledge_base.category.create.error_messages.message2' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<div class=\"form-group\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && categoryControl.file.errors }\">\n\t\t\t\t\t\t<label for=\"file\">{{'knowledge_base.category.create.fields.category_logo' | translate}}<span class=\"text-danger\">&nbsp;*</span></label>\n\t\t\t\t\t\t<input type=\"hidden\" formControlName=\"file\">\n\t\t\t\t\t\t<div class=\"dropzone dz-clickable\" #pdfdropzone>\n\t\t\t\t\t\t\t<div class=\"dz-default dz-message\"><span><strong>{{'knowledge_base.category.create.error_messages.message3' | translate}}</strong></span></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && categoryControl.file.errors\" class=\"invalid-feedback\">\n\t\t\t\t\t\t\t<div *ngIf=\"categoryControl.file.errors.required\">{{'knowledge_base.category.create.error_messages.message4' | translate}}</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<input type=\"hidden\" formControlName=\"file_extension\">\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<div class=\"modal-footer\">\n\t\t<button type=\"button\" class=\"btn btn-cancel mb-0\" (click)=\"onCancel()\">{{'common.close' | translate}}</button>\n\t\t<button type=\"submit\" class=\"btn btn-submit mb-0\">{{'common.create' | translate}}</button>\n\t</div>\n</form>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<section>\n\t<div class=\"row\">\n\t\t<!-- Tree view -->\n\t\t<div class=\"col-md-4\">\n\t\t\t<category-articles-tree></category-articles-tree>\n\t\t</div>\n\t\t<div class=\"col-md-8\" *ngIf=\"isPageLoaded\">\n\t\t\t<div class=\"card\">\n\t\t\t\t<div class=\"col-md-12\">\n\t\t\t\t\t<!-- Card header -->\n\t\t\t\t\t<div class=\"card-header pl-0 pr-0\">\n\t\t\t\t\t\t<h4 class=\"main-title mt-2\"><span>{{'knowledge_base.category.title2' | translate}}</span></h4>\n\t\t\t\t\t\t<div class=\"card-buttons d-flex\">\n\t\t\t\t\t\t\t<div class=\"btn-round-search mr-1\" *ngIf=\"categories?.length != 0\">\n\t\t\t\t\t\t\t\t<form [formGroup]=\"searchForm\" (ngSubmit)=\"onSubmit()\">\n\t\t\t\t\t\t\t\t\t<div class=\"input-group\">\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"{{'knowledge_base.category.create.placeholders.placeholder2' | translate}}\" aria-describedby=\"button-addon2\" formControlName=\"search\">\n\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-raised btn-round\" type=\"button\" type=\"submit\"><i class=\"fa fa-search\"></i></button>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</form>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<button class=\"btn btn-create mb-0\" *ngxPermissionsOnly=\"['admin', 'super_admin', 'knowledgebase_create']\" (click)=\"openCreateCategoryModal()\" tooltip=\"{{'common.create' | translate}}\"><i class=\"fa fa-plus\"></i></button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"card-content pb-2\">\n\t\t\t\t\t\t<div class=\"card-body\">\n\t\t\t\t\t\t\t<div class=\"row\" *ngIf=\"categories?.length != 0\">\n\t\t\t\t\t\t\t\t<div class=\"col-md-4 col-12\" *ngFor=\"let category of categories\">\n\t\t\t\t\t\t\t\t\t<div class=\"knowledge-technology\">\n\t\t\t\t\t\t\t\t\t\t<figure class=\"effect-marley\">\n\t\t\t\t\t\t\t\t\t\t\t<figcaption>\n\t\t\t\t\t\t\t\t\t\t\t\t<h2>{{category.category_name}}</h2>\n\t\t\t\t\t\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t\t\t\t\t\t<li *ngFor=\"let article of category.articles\"><a [routerLink]=\"['category/',category.id,'article',article.id]\">{{article.article_title}}</a></li>\n\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"listing-articles\"><a [routerLink]=\"['category/',category.id]\">{{'knowledge_base.article.title1' | translate}}</a></li>\n\t\t\t\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t\t\t\t</figcaption>\n\t\t\t\t\t\t\t\t\t\t</figure>\n\t\t\t\t\t\t\t\t\t\t<div class=\"image-box\">\n\t\t\t\t\t\t\t\t\t\t\t<img src=\"{{apiUrl}}/uploads/category_attachment/{{category.category_logo}}\" alt=\"Laravel\">\n\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class=\"text-center\" *ngIf=\"categories?.length == 0\">\n\t\t\t\t\t\t\t\t<img src=\"assets/img/norecord-img.png\" width=\"50\">\n\t\t\t\t\t\t\t\t<p class=\"mt-1\">{{'common.empty_message.categories' | translate}}</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</section>");
